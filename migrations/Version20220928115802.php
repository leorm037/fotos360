 ...
 */
final class Version20220928115802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, last_access DATETIME DEFAULT NULL, last_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL)');
